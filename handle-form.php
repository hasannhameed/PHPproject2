...
function save_data($data) {
    ...
    try {
        $connection = new PDO("mysql:dbname=trip;host=localhost", "testuser", "password");
    }
    ...
    try {
        $stmt = $connection->prepare("INSERT INTO trip (name, email, region, season, interests, participants, message) values (:name, :email, :region, :season, :interests, :participants, :message)");
